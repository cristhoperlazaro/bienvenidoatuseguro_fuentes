...
@Component({
  selector: 'app-economy-study-exercice',
  templateUrl: './economy-study-exercice.component.html',
  styleUrls: ['./economy-study-exercice.component.scss']
})
export class EconomyStudyExerciceComponent implements OnInit {
  comparativo: boolean;
  ahorro: boolean;
