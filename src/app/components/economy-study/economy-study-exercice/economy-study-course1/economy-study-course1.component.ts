...
@Component({
  selector: 'app-economy-study-course1',
  templateUrl: './economy-study-course1.component.html',
  styleUrls: ['./economy-study-course1.component.scss']
})
export class EconomyStudyCourse1Component implements OnInit {
