...
@Component({
  selector: 'app-economy-study-course',
  templateUrl: './economy-study-course.component.html',
  styleUrls: ['./economy-study-course.component.scss']
})
export class EconomyStudyCourseComponent implements OnInit {
