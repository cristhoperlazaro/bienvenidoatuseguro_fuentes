...
@Component({
  selector: 'app-economy-study-course2',
  templateUrl: './economy-study-course2.component.html',
  styleUrls: ['./economy-study-course2.component.scss']
})
export class EconomyStudyCourse2Component implements OnInit {
