...
@Component({
  selector: 'app-coworking-service',
  templateUrl: './coworking-service.component.html',
  styleUrls: ['./coworking-service.component.scss']
})
export class CoworkingServiceComponent implements OnInit {
  ...
  increment(){
    this.router.navigate(["/coworking-agenda"]);
  }
}
