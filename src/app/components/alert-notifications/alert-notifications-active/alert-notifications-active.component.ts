...
@Component({
  selector: 'app-alert-notifications-active',
  templateUrl: './alert-notifications-active.component.html',
  styleUrls: ['./alert-notifications-active.component.scss']
})
export class AlertNotificationsActiveComponent implements OnInit {
  loader: boolean;
  fono: string;
  mail: string;
  habilitado: boolean;
