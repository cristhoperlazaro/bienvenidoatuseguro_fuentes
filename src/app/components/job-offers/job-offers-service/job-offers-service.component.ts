...
@Component({
  selector: 'app-job-offers-service',
  templateUrl: './job-offers-service.component.html',
  styleUrls: ['./job-offers-service.component.scss']
})
export class JobOffersServiceComponent implements OnInit {
  config: any;
  count: number;
  loader: boolean;
  ofertas: Oferta[];
