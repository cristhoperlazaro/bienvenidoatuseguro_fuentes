...
@Component({
  selector: 'app-networking-scheduling',
  templateUrl: './networking-scheduling.component.html',
  styleUrls: ['./networking-scheduling.component.scss']
})
export class NetworkingSchedulingComponent implements OnInit {
