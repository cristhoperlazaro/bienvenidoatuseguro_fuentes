...
@Component({
  selector: 'app-networking-event-detail',
  templateUrl: './networking-event-detail.component.html',
  styleUrls: ['./networking-event-detail.component.scss']
})
export class NetworkingEventDetailComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.route.paramMap.subscribe(
      res => {
        ...
        object = JSON.parse(res['params']['event']);
        this.evento = object;
